...
struct AISettingsView: View {
    ...
    #if os(iOS)
    @StateObject private var backendAuthenticator = SettingsBackendWebAuthenticator()
    #endif
...
#if os(iOS)
@MainActor
private final class SettingsBackendWebAuthenticator: NSObject, ASWebAuthenticationPresentationContextProviding, ObservableObject {
...
private enum BackendAuthError: LocalizedError {
    case invalidBaseURL
